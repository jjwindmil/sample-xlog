...
export default function Xlog() {
  ...
  const render = () => {
    ...
    const xaxis = new Axis("linear","bottom").range(0,500).domain(0,10).render(x,0,500);
    const yaxis = new Axis("linear", "left").range(500,0).domain(0,10).render(y,undefined,undefined);
  };
